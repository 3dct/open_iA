/*=========================================================================
  ...
  Module:    $RCSfile: itkDualViewImageFusionFilter.h,v $
  Language:  C++
  Date:      $Date: 2009-08-10 11:01:02 $
...
#ifndef __itkDualViewImageFusionFilter_h
#define __itkDualViewImageFusionFilter_h
...
/** \class DualViewImageFusionFilter
...
class ITK_EXPORT DualViewImageFusionFilter :
    public InPlaceImageFilter<TInputImage1,TOutputImage> 
{
public:
  /** Standard class typedefs. */
  typedef DualViewImageFusionFilter						 Self;
  ...
  itkTypeMacro(DualViewImageFusionFilter, InPlaceImageFilter);
...
protected:
  ...
  virtual ~DualViewImageFusionFilter() {}

  /** DualViewImageFusionFilter can be implemented as a multithreaded filter.
...
#include "itkDualViewImageFusionFilter.txx"
#endif
