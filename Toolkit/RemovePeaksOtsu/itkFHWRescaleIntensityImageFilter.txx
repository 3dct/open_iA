 ...
 *
 *=========================================================================*/
#ifndef __itkFHWRescaleIntensityImageFilter_txx
#define __itkFHWRescaleIntensityImageFilter_txx
...
FHWRescaleIntensityImageFilter< TInputImage, TOutputImage >
...
::BeforeThreadedGenerateData()
{
 ...
 // m_InputMaximum = calculator->GetMaximum();
  ...
  this->GetFunctor().SetInMinimum(m_InputMinimum);
  this->GetFunctor().SetInMaximum(m_InputMaximum);
