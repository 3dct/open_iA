...
*          Stelzhamerstraяe 23, 4600 Wels / Austria, Email:                           *
* ************************************************************************************/
#pragma once
...
private:
	...
	double m_Smin;//минимальное значение из массива скал€ров
	double m_Smax;//максимальное значение из массива скал€ров
	double MinX,MaxX;
	double MinY,MaxY;
	double MinZ,MaxZ;
