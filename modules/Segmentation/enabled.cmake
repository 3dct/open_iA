if (openiA_TESTING_ENABLED)
	...
	if (MSVC)
		set_tests_properties(ImageGraphTest PROPERTIES ENVIRONMENT "PATH=${WinDLLPaths};$ENV{PATH}")
		set_tests_properties(DistanceMeasureTest PROPERTIES ENVIRONMENT "PATH=${WinDLLPaths};$ENV{PATH}")
