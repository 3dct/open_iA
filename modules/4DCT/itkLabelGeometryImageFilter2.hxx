...
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::MatrixType
...
CalculateOrientedImage(
  LabelGeometryImageFilter2< TLabelImage, TIntensityImage > *filter,
  vnl_symmetric_eigensystem< double > eig,
  typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::LabelGeometry & labelGeometry,
  bool useLabelImage)
{
  ...
  typename LabelGeometryImageFilter2< TLabelImage,
...
template< typename TLabelImage, typename TIntensityImage >
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
// 		  fileIt = files.find(label);
// 		  if(fileIt == files.end())
// 		  {
// 			  std::ofstream* f = new std::ofstream;
// 			  //f->open("C:\\data\\PixelIndices\\" + std::to_string(label) + ".txt");
// 			  files[label] = f;
// 		  }
// 		  files[label]->open("C:\\data\\PixelIndices\\" + std::to_string(label) + ".txt", std::ios::app);
// 		  (*files[label]) << index[0] << " " << index[1] << " " << index[2] << std::endl;
// 		  files[label]->close();
//      }
  ...
  for ( mapIt = m_LabelGeometryMapper.begin(); mapIt != m_LabelGeometryMapper.end(); mapIt++ )
    ...
    if ( m_CalculateOrientedBoundingBox == true )
      ...
      CalculateOrientedBoundingBoxVertices(eig, ( *mapIt ).second, (*mapIt).first);
      }
...
bool
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
::CalculateOrientedBoundingBoxVertices(vnl_symmetric_eigensystem< double > eig, LabelGeometry & labelGeometry, LabelPixelType label)
{
  // Calculate the oriented bounding box using the eigenvectors.
...
//   std::ifstream f;
//   f.open("C:\\data\\PixelIndices\\" + std::to_string(labelGeometry.m_Label) + ".txt");
//   char c;
//   unsigned int size = 0;
//   while (f.get(c))
// 	  if (c == '\n')
...
//		  pixelLocations(j, i) = indice[j] - labelGeometry.m_Centroid[j];
 	  pixelLocations(j, pixelId) = labelObj->GetIndex(pixelId)[j] - labelGeometry.m_Centroid[j];
      }
    }
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::LabelIndicesType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::RealType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::LabelPointType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::VectorType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::AxesLengthType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::BoundingBoxType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::LabelSizeType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::BoundingBoxVerticesType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
template< typename TLabelImage, typename TIntensityImage >
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::RegionType
LabelGeometryImageFilter2< TLabelImage, TIntensityImage >
...
void
LabelGeometryImageFilter2< TImage, TLabelImage >
