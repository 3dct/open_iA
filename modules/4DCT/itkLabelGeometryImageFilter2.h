 ...
 *
 *=========================================================================*/
#ifndef __itkLabelGeometryImageFilter2_h
#define __itkLabelGeometryImageFilter2_h
...
class LabelGeometryImageFilter2:
  public ImageToImageFilter< TLabelImage, TIntensityImage >
{
public:
  /** Standard Self typedef */
  typedef LabelGeometryImageFilter2                           Self;
  ...
  itkTypeMacro(LabelGeometryImageFilter2, ImageToImageFilter);
  ...
  typedef itk::LabelObject<LabelPixelType, ImageDimension> LabelObjectType;
...
private:
  ...
  bool CalculateOrientedBoundingBoxVertices(vnl_symmetric_eigensystem< double > eig, LabelGeometry & m_LabelGeometry, LabelPixelType label);
...
typename LabelGeometryImageFilter2< TLabelImage, TIntensityImage >::MatrixType CalculateRotationMatrix(
...
#include "itkLabelGeometryImageFilter2.hxx"
#endif
