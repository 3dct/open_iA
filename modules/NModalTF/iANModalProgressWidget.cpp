...
iANModalProgressWidget::iANModalProgressWidget(QWidget* parent) : QWidget(parent)
{
...
int iANModalProgressWidget::addProgressBar(
	int max, QString title, bool autoUpdateText /*=true*/, QString name /*=QString()*/)
{
	return addProgressBar(max, new QLabel(title), autoUpdateText, name);
}

int iANModalProgressWidget::addProgressBar(
	int max, QLabel* label, bool autoUpdateText /*=false*/, QString name /*=QString()*/)
{
...
iANModalProgressUpdater::iANModalProgressUpdater(iANModalProgressWidget* progress)
{
	...
	connect(this, &iANModalProgressUpdater::setFirstValue, progress, &iANModalProgressWidget::setFirstValue,
		CONNECTION_TYPE);

	connect(this, QOverload<int, int>::of(&iANModalProgressUpdater::setValue), progress,
		QOverload<int, int>::of(&iANModalProgressWidget::setValue), CONNECTION_TYPE);
	connect(this, QOverload<int, int>::of(&iANModalProgressUpdater::setMax), progress,
		QOverload<int, int>::of(&iANModalProgressWidget::setMax), CONNECTION_TYPE);
	connect(this, QOverload<int, bool>::of(&iANModalProgressUpdater::setAutoUpdateText), progress,
		QOverload<int, bool>::of(&iANModalProgressWidget::setAutoUpdateText), CONNECTION_TYPE);
	connect(this, QOverload<int, QString>::of(&iANModalProgressUpdater::setText), progress,
		QOverload<int, QString>::of(&iANModalProgressWidget::setText), CONNECTION_TYPE);

	connect(this, QOverload<QString, int>::of(&iANModalProgressUpdater::setValue), progress,
		QOverload<QString, int>::of(&iANModalProgressWidget::setValue), CONNECTION_TYPE);
	connect(this, QOverload<QString, int>::of(&iANModalProgressUpdater::setMax), progress,
		QOverload<QString, int>::of(&iANModalProgressWidget::setMax), CONNECTION_TYPE);
	connect(this, QOverload<QString, bool>::of(&iANModalProgressUpdater::setAutoUpdateText), progress,
		QOverload<QString, bool>::of(&iANModalProgressWidget::setAutoUpdateText), CONNECTION_TYPE);
	connect(this, QOverload<QString, QString>::of(&iANModalProgressUpdater::setText), progress,
		QOverload<QString, QString>::of(&iANModalProgressWidget::setText), CONNECTION_TYPE);
}
