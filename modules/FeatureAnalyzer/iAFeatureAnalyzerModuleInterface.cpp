...
void iAFeatureAnalyzerModuleInterface::Initialize()
{
	...
	connect( uiComputeSegm.computerName, &QLineEdit::editingFinished, this, &iAFeatureAnalyzerModuleInterface::compNameChanged);
	connect( uiComputeSegm.tbReload,  &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::loadCSV);
	connect( uiComputeSegm.tbSave, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::saveCSV);
	connect( uiComputeSegm.tbOpenCSV, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::browseCSV);
	connect( uiComputeSegm.tbOpenResultsFolder,  &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::browserResultsFolder);
	connect( uiComputeSegm.tbOpenDatasetsFolder, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::browserDatasetsFolder);
	connect( uiComputeSegm.pbRunCalculations, &QPushButton::clicked, this, &iAFeatureAnalyzerModuleInterface::runCalculations);
	connect( uiComputeSegm.pbShowLogs, &QPushButton::clicked, this, &iAFeatureAnalyzerModuleInterface::showHideLogs);
	connect( uiComputeSegm.tbDatasetPreview, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::generateDatasetPreviews);
...
void iAFeatureAnalyzerModuleInterface::computeParameterSpace()
{
	...
	connect(btClearPipeline, &QPushButton::clicked, this, &iAFeatureAnalyzerModuleInterface::clearPipeline);
	connect(btAddPipeline, &QPushButton::clicked, this,   &iAFeatureAnalyzerModuleInterface::addPipeline);
	connect(btIncPipeline, &QPushButton::clicked, this,   &iAFeatureAnalyzerModuleInterface::resizePipeline);
	connect(btDecPipeline, &QPushButton::clicked, this,   &iAFeatureAnalyzerModuleInterface::resizePipeline);
...
void iAFeatureAnalyzerModuleInterface::removeGTDatasets( QStringList& list, const QStringList& toDelete )
{
...
void iAFeatureAnalyzerModuleInterface::loadCSV()
{
...
void iAFeatureAnalyzerModuleInterface::displayPipelineInSlots( QTableWidgetItem * item)
{
...
void iAFeatureAnalyzerModuleInterface::SaveSettings() const
{
	updateFromGUI();
	QSettings settings( organisationName, applicationName );
...
void iAFeatureAnalyzerModuleInterface::updateFromGUI() const
{
...
void iAFeatureAnalyzerModuleInterface::browserResultsFolder()
{
...
void iAFeatureAnalyzerModuleInterface::browserDatasetsFolder()
{
...
void iAFeatureAnalyzerModuleInterface::runCalculations()
{
	iARunBatchThread * rbt = new iARunBatchThread( this );
	connect( rbt, &iARunBatchThread::batchProgress, this, &iAFeatureAnalyzerModuleInterface::batchProgress);
	connect( rbt, &iARunBatchThread::totalProgress, this, &iAFeatureAnalyzerModuleInterface::totalProgress);
	connect( rbt, &iARunBatchThread::currentBatch,  this, &iAFeatureAnalyzerModuleInterface::currentBatch);
	rbt->Init(this,
		m_datasetsFolder,
...
void iAFeatureAnalyzerModuleInterface::showHideLogs()
{
...
void iAFeatureAnalyzerModuleInterface::log( QString text, bool appendToPrev )
{
	if( appendToPrev )
	{
...
Ui::ComputeSegmentations * iAFeatureAnalyzerModuleInterface::ui()
{
	return &uiComputeSegm;
}

QString iAFeatureAnalyzerModuleInterface::DatasetFolder() const
{
	return m_datasetsFolder;
}

QString iAFeatureAnalyzerModuleInterface::ResultsFolder() const
{
	return m_resultsFolder;
}

QString iAFeatureAnalyzerModuleInterface::CSVFile() const
{
	return m_csvFile;
}

void iAFeatureAnalyzerModuleInterface::batchProgress( int progress )
{
	uiComputeSegm.batchProgress->setValue( progress );
	QCoreApplication::processEvents();
}

void iAFeatureAnalyzerModuleInterface::totalProgress( int progress )
{
	uiComputeSegm.totalProgress->setValue( progress );
	QCoreApplication::processEvents();
}

void iAFeatureAnalyzerModuleInterface::currentBatch(QString str )
{
	uiComputeSegm.laBatchProgress->setText( str );
	QCoreApplication::processEvents();
}

QString iAFeatureAnalyzerModuleInterface::ComputerName() const
{
...
//void iAFeatureAnalyzerModuleInterface::launchCalcPoreProps()
//{
...
void iAFeatureAnalyzerModuleInterface::clearPipeline()
{
	iADropPipelineWidget* dpw = uiComputeSegm.dragWidget->findChild<iADropPipelineWidget*>( "dropPipelineWidget" );
	dpw->clearAllSlots();
}

void iAFeatureAnalyzerModuleInterface::addPipeline()
{
	iADropPipelineWidget* dpw = uiComputeSegm.dragWidget->findChild<iADropPipelineWidget*>( "dropPipelineWidget" );
...
void iAFeatureAnalyzerModuleInterface::resizePipeline()
{
...
void iAFeatureAnalyzerModuleInterface::clearTableWidgetItem()
{
...
void iAFeatureAnalyzerModuleInterface::setupTableWidgetContextMenu()
{
...
void iAFeatureAnalyzerModuleInterface::createTableWidgetActions()
{
	...
	connect( removeRowAction, &QAction::triggered, this, &iAFeatureAnalyzerModuleInterface::clearTableWidgetItem);
	connect( uiComputeSegm.tbRemoveRow, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::clearTableWidgetItem);
	connect( saveTableToCSVAction, &QAction::triggered, this, &iAFeatureAnalyzerModuleInterface::saveCSV);
	connect( uiComputeSegm.tbSaveTable, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::saveCSV);
	connect( loadTableFromCSVAction, &QAction::triggered, this, &iAFeatureAnalyzerModuleInterface::loadCSV);
	connect( uiComputeSegm.tbLoadTable, &QToolButton::clicked, this, &iAFeatureAnalyzerModuleInterface::loadCSV);
	connect( uiComputeSegm.tableWidget, &QTableWidget::itemClicked, this, &iAFeatureAnalyzerModuleInterface::displayPipelineInSlots);
}

void iAFeatureAnalyzerModuleInterface::generateDatasetPreviews()
{
	iADatasetInfo * prev = new iADatasetInfo( this );
	connect( prev, &iADatasetInfo::finished, this, &iAFeatureAnalyzerModuleInterface::datasetPreviewThreadFinished);
	connect( prev, &iADatasetInfo::started, this, &iAFeatureAnalyzerModuleInterface::datasetPreviewThreadStarted);
...
void iAFeatureAnalyzerModuleInterface::datasetPreviewThreadFinished()
{
...
void iAFeatureAnalyzerModuleInterface::datasetPreviewThreadStarted()
{
