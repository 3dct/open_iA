...
dlg_tf_2mod::dlg_tf_2mod(MdiChild *parent, Qt::WindowFlags f)
	:
	QDockWidget("Double Histogram Transfer Function", parent, f),
	m_mdiChild(parent)
{
...
dlg_TripleHistogramTF::dlg_TripleHistogramTF(MdiChild * mdiChild, Qt::WindowFlags f) :
