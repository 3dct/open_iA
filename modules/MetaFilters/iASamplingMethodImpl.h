...
//! Generates additional sensitivity samplings for each parameter set generated by another given generator.
class MetaFilters_API iAGeneralSensitivitySamplingMethod : public iASamplingMethod
{
public:
	iAGeneralSensitivitySamplingMethod(QSharedPointer<iASamplingMethod> otherGenerator, double delta);
	static QString Name;
	QString name() const override;
	iAParameterSetsPointer parameterSets(QSharedPointer<iAAttributes> parameter, int sampleCount) override;
private:
