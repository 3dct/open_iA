if (openiA_TESTING_ENABLED)
	...
	set(TEST_COMMAND ${GUITestBinary} ${TEST_DATA_DIR}/fibers/5-ROI-FeatureScout-LabelVis-NoAutoID.iaproj --quit 500 --screenshot ${TEST_OUTPUT_FILE} --size 1920x1080)
	...
	set(TEST_OUTPUT_FILE ${TEST_OUTPUT_DIR}/${TEST_NAME}.png)
	set(TEST_COMMAND ${GUITestBinary} ${TEST_DATA_DIR}/fibers/5-ROI-FeatureScout-CylinderVis-WithAutoID.iaproj --quit 500 --screenshot ${TEST_OUTPUT_FILE} --size 1920x1080)
	set(TEST_SCRIPT_NAME "${CMAKE_BINARY_DIR}/${TEST_NAME}.cmake")
	configure_file(${TEST_TEMPLATE_SCRIPT_FILE} ${TEST_SCRIPT_NAME} @ONLY)
	add_test(NAME ${TEST_NAME} COMMAND ${CMAKE_COMMAND} -P ${TEST_SCRIPT_NAME})
	...
	set(TEST_OUTPUT_FILE ${TEST_OUTPUT_DIR}/${TEST_NAME}.png)
	set(TEST_COMMAND ${GUITestBinary} ${TEST_DATA_DIR}/fibers/5-ROI-FeatureScout-MeanObjects.iaproj --quit 500 --screenshot ${TEST_OUTPUT_FILE} --size 1920x1080)
	set(TEST_SCRIPT_NAME "${CMAKE_BINARY_DIR}/${TEST_NAME}.cmake")
	configure_file(${TEST_TEMPLATE_SCRIPT_FILE} ${TEST_SCRIPT_NAME} @ONLY)
	add_test(NAME ${TEST_NAME} COMMAND ${CMAKE_COMMAND} -P ${TEST_SCRIPT_NAME})
endif()
