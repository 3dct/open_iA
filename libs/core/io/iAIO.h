...
iAcore_API mapQString2int const & extensionToId();
iAcore_API mapQString2int const & extensionToIdStack();
iAcore_API mapQString2int const & extensionToSaveId();
...
class iAcore_API iAIO : public iAAlgorithm
{
	Q_OBJECT
public:
