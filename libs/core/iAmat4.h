...
public:
	...
	friend	iAcore_API iAMat4   operator * ( const iAMat4&, const iAMat4& );
	friend	iAcore_API iAVec3f operator * ( const iAMat4&, const iAVec3f& );
};

//iAVec3f operator * (const iAMat4 &, const iAVec3f &);

iAcore_API iAMat4	translate ( const iAVec3f& );
iAcore_API iAMat4	scale     ( const iAVec3f& );
iAcore_API iAMat4	rotation  ( const iAVec3f& v, float );
iAcore_API iAMat4	rotationX   ( float );
iAcore_API iAMat4	rotationY   ( float );
iAcore_API iAMat4	rotationZ   ( float );
/*
