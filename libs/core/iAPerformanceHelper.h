...
//! that time
class iAcore_API iAPerformanceTimer
{
public:
...
class iAcore_API iAPerformanceHelper
{
public:
	iAPerformanceHelper();
	~iAPerformanceHelper();
...
iAcore_API QString formatDuration(double duration, bool showMS=true);
