...
//! Support for loading/saving OBJ files for the file I/O framework of open_iA.
class iAOBJFileIO : public iAFileIO, private iAAutoRegistration<iAFileIO, iAOBJFileIO, iAFileTypeRegistry>
{
public:
	iAOBJFileIO();
