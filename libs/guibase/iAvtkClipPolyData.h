 ...
 *
 * iAvtkClipPolyData is a filter that clips polygonal data using either
 ...
 *
 * @warning
 * In order to cut all types of cells in polygonal data, iAvtkClipPolyData
...
public:
  ...
  /**
   * Add implicit functions with which to perform the
...
private:
  iAvtkClipPolyData(const iAvtkClipPolyData&) = delete;
  void operator=(const iAvtkClipPolyData&) = delete;
};
