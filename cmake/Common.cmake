...
if (MSVC)
	...
	message(STATUS "Compiler: Visual C++ (MSVC_VERSION ${MSVC_VERSION} / COMPILER ${CMAKE_CXX_COMPILER_VERSION} / VS BUILD  ${CMAKE_VS_VERSION_BUILD_NUMBER} / SDK ${CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION})")
