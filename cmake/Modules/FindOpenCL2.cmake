...
#ITK version of FindOpenCL.CMAKE (ITK\CMake\FindOpenCL.cmake)
...
if (APPLE)
	...
	if (WIN32)
		...
		if( ${OPENCL_INCLUDE_DIRS} STREQUAL "OPENCL_INCLUDE_DIRS-NOTFOUND" )
			set( SEARCH_PATH ${OPENCL_ROOT_DIR}/inc ${OPENCL_ROOT_DIR}/common/inc ${PATH} "C:/ProgramData/NVIDIA Corporation/NVIDIA GPU Computing SDK/OpenCL/common/inc" "$ENV{CUDA_PATH}" "$ENV{CUDA_PATH_V6_5}" "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v6.5/include" "$ENV{ATISTREAMSDKROOT}/include" "C:/Program Files (x86)/AMD APP/include")
