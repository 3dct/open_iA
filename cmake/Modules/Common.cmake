...
IF (OPENCL_FOUND)
	...
	ELSEIF (UNIX)
		...
		FOREACH(OPENCL_LIB ${OPENCL_LIBRARIES})
			...
			INSTALL (FILES "${OPENCL_SHAREDLIB}" DESTINATION .)
		ENDFOREACH()
	ENDIF()
ENDIF()
...
IF (CUDA_FOUND)
	...
	ELSEIF(UNIX)
		...
		INSTALL (FILES "${CUDART_SHAREDLIB}" DESTINATION . RENAME libcudart.so)
		INSTALL (FILES "${CUFFT_SHAREDLIB}" DESTINATION . RENAME libcufft.so)
	ENDIF ()
ENDIF()
...
IF (ASTRA_TOOLBOX_FOUND)
	...
	ELSEIF(UNIX)
		...
		INSTALL (FILES "${ASTRA_SHAREDLIB}" DESTINATION . RENAME libastra.so)
	ENDIF ()
ENDIF()
