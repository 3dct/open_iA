...
IF (CMAKE_MAJOR_VERSION GREATER 3 OR (CMAKE_MAJOR_VERSION EQUAL 3 AND CMAKE_MINOR_VERSION GREATER 10))
...
IF (MSVC)
	...
	SET (RelWithDebInfoLibraryPaths "${VTK_WIN_DIR}\\bin\\$(Configuration);${ITK_WIN_DIR}\\bin\\$(Configuration);${Qt5_WIN_DIR}")
	SET (ReleaseLibraryPaths "${VTK_WIN_DIR}\\bin\\$(Configuration);${ITK_WIN_DIR}\\bin\\$(Configuration);${Qt5_WIN_DIR}")
	SET (DebugLibraryPaths "${VTK_WIN_DIR}\\bin\\$(Configuration);${ITK_WIN_DIR}\\bin\\$(Configuration);${Qt5_WIN_DIR}")
	SET (MinSizeRelLibraryPaths "${VTK_WIN_DIR}\\bin\\$(Configuration);${ITK_WIN_DIR}\\bin\\$(Configuration);${Qt5_WIN_DIR}")
	...
	IF (HDF5_FOUND)
		...
		IF (EXISTS "${HDF5_BASE_DIR}\\bin\\Release")
			SET (RelWithDebInfoLibraryPaths "${HDF5_BASE_DIR}\\bin\\$(Configuration);${RelWithDebInfoLibraryPaths}")
			SET (ReleaseLibraryPaths "${HDF5_BASE_DIR}\\bin\\$(Configuration);${ReleaseLibraryPaths}")
			SET (DebugLibraryPaths "${HDF5_BASE_DIR}\\bin\\$(Configuration);${DebugLibraryPaths}")
			SET (MinSizeRelLibraryPaths "${HDF5_BASE_DIR}\\bin\\$(Configuration);${MinSizeRelLibraryPaths}")
		ELSE()
	...
	IF (ELASTIX_LIBRARY_DIRS)
		SET (RelWithDebInfoLibraryPaths "${ELASTIX_LIBRARY_DIRS}/$(Configuration);${RelWithDebInfoLibraryPaths}")
		SET (ReleaseLibraryPaths "${ELASTIX_LIBRARY_DIRS}/$(Configuration);${ReleaseLibraryPaths}")
		SET (DebugLibraryPaths "${ELASTIX_LIBRARY_DIRS}/$(Configuration);${DebugLibraryPaths}")
		SET (MinSizeRelLibraryPaths "${ELASTIX_LIBRARY_DIRS}/$(Configuration);${MinSizeRelLibraryPaths}")
	ENDIF()
