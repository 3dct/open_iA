...
if (HDF5_FOUND)
	if (HDF5_VERSION VERSION_GREATER_EQUAL "1.13.0")
		set(HDF5_LIBRARY hdf5::hdf5-static hdf5::zlib-static hdf5::aec-static hdf5::szaec-static)
	else()
		...
		set(HDF5_SZIP_LIB_ALT_NAME2 libszaec${CMAKE_STATIC_LIBRARY_SUFFIX})
		set(HDF5_Z_LIB_NAME libzlib${CMAKE_STATIC_LIBRARY_SUFFIX})
		set(HDF5_Z_LIB_ALT_NAME libz${CMAKE_STATIC_LIBRARY_SUFFIX})
		find_path(HDF5_INCLUDE_OVERWRITE_DIR hdf5.h PATHS "${HDF5_DIR}/../include" "${HDF5_DIR}/../../include" "${HDF5_DIR}/../../../include")
		set(HDF5_INCLUDE_DIR "${HDF5_INCLUDE_OVERWRITE_DIR}" CACHE PATH "" FORCE)
		unset(HDF5_INCLUDE_OVERWRITE_DIR CACHE)
		find_library(HDF5_CORE_LIB ${HDF5_CORE_LIB_NAME} PATHS ${HDF5_DIR}/../lib ${HDF5_DIR}/../../lib ${HDF5_DIR}/../../../lib)
		find_library(HDF5_Z_LIB ${HDF5_Z_LIB_NAME} NAMES ${HDF5_Z_LIB_ALT_NAME} PATHS ${HDF5_DIR}/../lib ${HDF5_DIR}/../../lib ${HDF5_DIR}/../../../lib NO_DEFAULT_PATH NO_CMAKE_ENVIRONMENT_PATH NO_CMAKE_PATH NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH NO_CMAKE_FIND_ROOT_PATH)
		find_library(HDF5_SZIP_LIB ${HDF5_SZIP_LIB_NAME} NAMES ${HDF5_SZIP_LIB_ALT_NAME} ${HDF5_SZIP_LIB_ALT_NAME2} PATHS ${HDF5_DIR}/../lib ${HDF5_DIR}/../../lib ${HDF5_DIR}/../../../lib)
