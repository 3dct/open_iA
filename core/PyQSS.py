...
****************************************************************************/
	...
	QMdiArea::background
	{
		background-color: $mdiBackground$;
	}
	...
	QTabBar::tab
	{
		$gradientWithBreak((0,0), (0,1), golden, iwGradient[0], iwGradient[1], gradStep)$
	}
...
****************************************************************************/
	...
	{
		$gradientWithBreak((0,0), (0,1), 1 - golden, blueGradient[1], blueGradient[0], gradStep)$
	}
	...
	{
		$gradientWithBreak((0,0), (0,1), 1 - golden, redGradient[0], redGradient[1], gradStep)$
	}
...
****************************************************************************/
	...
	{
		background: $disabledMenuItemCol$;
	}
...
****************************************************************************/
	QMenu
	{
		background-color: $black$; /* sets background of the menu */ /*border: 1px solid black;*/
	}
...
****************************************************************************/
	...
	{
		border-style: outset;
		border-top: 1px solid 		$pbBrd[0]$;
		border-bottom: 1px solid 	$pbBrd[1]$;
		border-left: 0px solid 		$pbSideBrd$;
		border-right: 0px solid		$pbSideBrd$;
		/*border-radius: 0.3em;*/
		padding: 0px 6px;
		min-width: 3em;
		min-height: 2em;
	...
	QPushButton:hover
	{
		border-top: 1px solid 		$blueBrd[0]$;
		border-bottom: 1px solid 	$blueBrd[1]$;
		border-left: 0px solid 		$blueSideBrd$;
		border-right: 0px solid		$blueSideBrd$;
		$gradientWithBreak((0,0), (0,1), golden, blueGradient[0], blueGradient[1], gradStep)$
	}
...
****************************************************************************/
	...
	QListView::item:selected 
	{
		...
		border-top: 1px solid 		$pbBrd[0]$;
		border-bottom: 1px solid 	$pbBrd[1]$;
		border-left: 1px solid 		$pbSideBrd$;
		border-right: 1px solid		$pbSideBrd$;
	}
	
	QListView::item:alternate
	{
		background: $listItemBg[1]$;
		color: $listBg[0]$;
	}
	
	QListView::item:hover
	{
		background: $listItemBg[0] + listHoverJump$;
		color: $listBg[1]$;
...
if __name__ == "__main__":
    a_file = open("dark.qss", "w")
    dark = parse(qss_str)
    print (dark), ("\n\n\n\n")
    a_file.write(dark)
    a_file.close()
    darkToBright()
    a_file = open("bright.qss", "w")
