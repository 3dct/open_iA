...
public:
	...
	void draw( QPainter& painter, double binWidth, size_t startBin, size_t endBin, QSharedPointer<iAMapper> yMapper) const override;
private:
	int m_position;
};
...
private:
	virtual bool computePolygons(double binWidth, size_t startBin, size_t endBin, QSharedPointer<iAMapper> yMapper) const =0;
...
protected:
	...
	mutable QSharedPointer<iAMapper> m_cachedYMapper;
...
private:
	bool computePolygons(double binWidth, size_t startBin, size_t endBin, QSharedPointer<iAMapper> yMapper) const override;
