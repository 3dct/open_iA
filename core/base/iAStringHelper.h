...
base_API QStringList splitPossiblyQuotedString(QString const & str);

base_API QString quoteString(QString const & str);
...
base_API QString padOrTruncate(QString const & str, int size);
...
base_API QString stripHTML(QString const & html);

//! returns the value converted to string, with units (K, M, G, T, P) applied for every 10³ factor over 1000
base_API QString dblToStringWithUnits(double value, double switchFactor = 1000);
...
base_API int greatestCommonPrefixLength(QString const & str1, QString const & str2);
base_API QString greatestCommonPrefix(QString const & str1, QString const & str2);

base_API int greatestCommonSuffixLength(QString const & str1, QString const & str2);
base_API QString greatestCommonSuffix(QString const & str1, QString const & str2);

//! Get the number of digits required for the given number (before the comma).
base_API int requiredDigits(double value);
...
//! 0.0999 - 0.01   2-3
//! 0.0099 - 0.001  3-4
base_API int digitsAfterComma(double resolvableDiff);
