...
class base_API iAVectorColorTheme: public iAColorTheme
{
public:
...
class base_API iASingleColorTheme : public iAColorTheme
{
public:
...
//! themes.
class base_API iAColorThemeManager
{
public:
