...
class charts_API iASelectedBinPlot : public iAPlot
{
public:
...
class charts_API iALinePlot: public iAPlot
{
public:
...
class charts_API iAStepFunctionPlot : public iAPlot
{
public:
...
class charts_API iAFilledLinePlot : public iAPlot
{
public:
...
class charts_API iABarGraphPlot: public iAPlot
{
public:
...
class charts_API iAPlotCollection: public iAPlot
{
public:
	iAPlotCollection();
	void draw(QPainter& painter, size_t startIdx, size_t endIdx, iAMapper const& xMapper, iAMapper const& yMapper) const override;
